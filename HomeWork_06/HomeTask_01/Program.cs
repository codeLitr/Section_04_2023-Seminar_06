...
// 1.запросить сколько чисел
// 2.сделать цикл по запросу этих чисел, но с ограничением введеного выше числа
// 3.сделать условие, что если число больше 0, то прибавть 1 к переменной счетчика
